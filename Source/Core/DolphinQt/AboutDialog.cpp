...
AboutDialog::AboutDialog(QWidget* parent) : QDialog(parent)
{
  ...
  const QString text =
      QStringLiteral(R"(
<p style='font-size:38pt; font-weight:400;'>BrGL-Dolphin</p>
...
<p>
%CHECK_FOR_UPDATES%: <a href='https://github.com/Defal7c/dolphin/releases'>github.com/Defal7c/dolphin</a>
</p>
...
<a href='https://forums.dolphin-emu.org/'>%SUPPORT%</a>
          ...
          .replace(QStringLiteral("%ABOUT_DOLPHIN%"),
                   ...
                   tr("BrGL-Dolphin is a Sonic Riders centric fork of Dolphin."))
      ...
      QStringLiteral("<small>%1</small>")
          .arg(
              ...
              tr("\u00A9 2003-2015+ Dolphin Team. \u201cGameCube\u201d and \u201cWii\u201d are "
                 "trademarks of Nintendo. Dolphin and BrGL-Dolphin is not affiliated with Nintendo in any way.")));
